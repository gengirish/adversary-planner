# Campaign Report: e2e-validation-test

**Campaign ID:** `8bbe69c1`
...
- **Suggested garak probes:** `probes.grandma`
...
### 3. Tree of Attacks (TAP)
- **Family:** automated_red_team
- **Posterior Mean:** 58.8%
- **Uncertainty:** ±16.4%
- **Rationale:** High uncertainty — untested, worth exploring
- **Suggested garak probes:** `probes.tap`

### 4. Multi-turn Jailbreak
- **Family:** jailbreak
- **Posterior Mean:** 49.3%
- **Uncertainty:** ±12.9%
- **Rationale:** Prior suggests moderate success probability
...
- **Uncertainty:** ±16.6%
- **Rationale:** High uncertainty — untested, worth exploring
- **Suggested garak probes:** `probes.snowball`
...
---
*Report generated by Adversary Planner v0.1.0 on 2026-04-01 17:43*